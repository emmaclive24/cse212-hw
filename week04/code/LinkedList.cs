...
public class LinkedList : IEnumerable<int>
{
	...
	{
		// TODO Problem 2
		 if (_head == _tail) // If the list has only one node or is empty
	{
		_head = null;
		_tail = null;
	}
	...
	public void Remove(int value)
	{
		...
		if (_head is null) return; // List is empty, nothing to remove
	...
	while (curr is not null)
	{
		if (curr.Data == value)
		{
			...
			return; // Exit after finding and removing the node
		}
		curr = curr.Next;
	}
	}
